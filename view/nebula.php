    ...
    <div class="bicicleta container">
      <div class="bicicleta-imagens">
       ...
       <div class="bicicleta-conteudo">
        <p class="font-2-l cor-5">A Nimbus Stark é a melhor já criada pela nossa equipe. Ela vem equipada com os melhores acessórios, o que garante maior velocidade.</p>
        ...
        <ul class="bicicleta-informacoes">
          ...
          <li>
            ...
            <p class="font-2-xs cor-5">Maior proteção possível para a sua com fibra de carbono.</p>
          </li>
        </ul>
    ...
    <div class="footer container">
      ...
      <div class="footer-contato">
        ...
        <ul class="font-2-m cor-5">
          <li><a href="tel:+552199999999">+55 18 9999-9999</a></li>
          <li><a href="mailto:contato@bikcraft.com">contato@.com</a></li>
